      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className={`absolute inset-0 w-full h-full transition-opacity duration-2000 ${videoError ? 'opacity-0' : 'opacity-100'}`}>
          <div className="absolute inset-0 w-full h-full bg-black">
            <iframe
              id="anna-video"
              src="https://rutube.ru/play/embed/be478c37f13456b40713629e6fb15ff7/?p=xkn0V2Q3tQFN5d8pwZH1Eg&autoStart=1&mute=1&loop=1&skinColor=transparent&rel=0&showinfo=0&controls=0&modestbranding=1&playsinline=1"
              width="100%"
              height="100%"
            ...
            {/* Дополнительная попытка через другой URL формат */}
            <div className="absolute inset-0 opacity-0">
              <iframe
                src="https://rutube.ru/video/be478c37f13456b40713629e6fb15ff7/?autoplay=1&muted=1&loop=1"
                width="100%"
                height="100%"
